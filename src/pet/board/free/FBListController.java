...
public class FBListController extends SuperClass {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalCount = bdao.selectTotalCount_F(
							parameters.getMode(),
							parameters.getKeyword());
		
		String contextPath = request.getContextPath();
		String myurl = contextPath + "/Mypet?command=FBList";
		...
		List<Board> lists = bdao.readBoardList_F(
		...
		String gotopage = "board/board_free/FBList.jsp";
